...
import com.knwedu.adapter.TutorialDailyDiaryAdapter;
...
public class ActivityTutorialDailyDiary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityTutorialDailyDiary.this;
        getSupportActionBar().setTitle("Tutorial");
        TutorialDailyDiaryAdapter adapter = new TutorialDailyDiaryAdapter();
