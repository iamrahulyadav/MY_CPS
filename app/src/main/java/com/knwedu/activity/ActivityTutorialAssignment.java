...
import com.knwedu.adapter.TutorialAssignemntAdapter;
...
public class ActivityTutorialAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityTutorialAssignment.this;
        getSupportActionBar().setTitle("Tutorial");
        TutorialAssignemntAdapter adapter = new TutorialAssignemntAdapter();
