...
/**
 * Created by knowalluser on 26-03-2018.
 */

public class ActivitySynchronize extends AppCompatActivity {
    String error;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = ActivitySynchronize.this;
    ...
    private void initialize() {
        mDatabase = ((SchoolApplication) getApplicationContext()).getDatabase();
        ...
        btnSync.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (SchoolAppUtils.isOnline(mContext)) {
                    ...
                    SchoolAppUtils.showDialog(mContext,
    ...
    class OfflineSyncAsync extends AsyncTask<Void, Integer, Boolean> {
        ...
        private void uploadAssignmentRequest() {
            ...
            ArrayList<DataStructureFramwork.Assignment> assignments = new ArrayList<DataStructureFramwork.Assignment>();
        ...
        private void uploadAttendanceRequest() {
            ...
            for (int i = 0; i < atten_lecturenum.size(); i++) {
                if (tryNext) {
                    ...
                    ArrayList<DataStructureFramwork.Attendance> attendance = new ArrayList<DataStructureFramwork.Attendance>();
        ...
        private void uploadAnnouncementRequest() {
            boolean tryNext = true;
            ArrayList<DataStructureFramwork.Announcement> announcement = new ArrayList<DataStructureFramwork.Announcement>();
        ...
        private void UploadLessonPlan(String type1) {
            ...
            boolean tryNext = true;
            ArrayList<DataStructureFramwork.TeacherSchedule> schedule = new ArrayList<DataStructureFramwork.TeacherSchedule>();
