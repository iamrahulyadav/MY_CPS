...
public class ActivityBusTracking extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ais_transport_view);
...
//		});
    ...
    private void initialize() {
        subscribe = (TextView) findViewById(R.id.btn_subscribe);
        status = (TextView) findViewById(R.id.status);
        txt_rout_no = (TextView) findViewById(R.id.txt_rout_no);
        btn_set_alert = (TextView) findViewById(R.id.btn_set_alert);
