...
import com.knwedu.adapter.TutorialClassworkAdapter;
...
public class ActivityTutorialClassWork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ActivityTutorialClassWork.this;
        getSupportActionBar().setTitle("Tutorial");
        TutorialClassworkAdapter adapter = new TutorialClassworkAdapter();
