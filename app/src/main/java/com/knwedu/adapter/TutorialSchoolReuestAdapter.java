...
public class TutorialSchoolReuestAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        switch (position) {
            case 0:
                resId = R.layout.viewpager_school_reuest_first;
                break;
            case 1:
                resId = R.layout.viewpager_school_reuest_second;
                break;
           /* case 2:
