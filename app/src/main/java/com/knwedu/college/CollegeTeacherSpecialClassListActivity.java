...
public class CollegeTeacherSpecialClassListActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if ((CollegeAppUtils.GetSharedParameter(
				CollegeTeacherSpecialClassListActivity.this,
				CollegeConstants.COLLEGE_SPECIALCLASS_CREATE)).equals("0")) {
			...
			addAssignment.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					Intent intent = new Intent(
							CollegeTeacherSpecialClassListActivity.this,
							CollegeTeacherSpecialClassActivity.class);
	...
	private void loadData() {
		...
		nameValuePairs.add(new BasicNameValuePair("id", CollegeAppUtils
				.GetSharedParameter(
						CollegeTeacherSpecialClassListActivity.this, "id")));
	...
	private class GetAssignmentsAsyntask extends
		...
		protected Boolean doInBackground(List<NameValuePair>... params) {
			...
			JSONObject json = jParser.getJSONFromUrlnew(namevaluepair,
					CollegeUrls.api_specialclass_view_teacher);
			try {
