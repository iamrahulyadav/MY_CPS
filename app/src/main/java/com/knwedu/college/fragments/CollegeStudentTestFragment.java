...
public class CollegeStudentTestFragment extends Fragment {
	...
	public CollegeStudentTestFragment(int type) {
		super();
		this.type = type;
	}
...
//		});
	...
	OnItemClickListener listener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3) {
			Intent intent = new Intent(getActivity(), CollegeTestActivity.class);
	...
	private class GetAssignmentAsyntask extends
		...
		protected void onPreExecute() {
			...
			dialog.setTitle(getResources().getString(R.string.test));
		...
		protected Boolean doInBackground(List<NameValuePair>... params) {
			...
			// Log parameters:
			Log.d("url extension", CollegeUrls.api_activity_get_test);
			String parameters = "";
			...
			JSONObject json = jParser.getJSONFromUrlnew(nameValuePairs,
					CollegeUrls.api_activity_get_test);
			try {
		...
		if (CollegeMainActivity.showMonthWeek != null) {
			CollegeMainActivity.showMonthWeek
					.setOnClickListener(new OnClickListener() {
						...
						@Override
						public void onClick(View v) {
							String myStr = CollegeMainActivity.showMonthWeek
									.getText().toString();
