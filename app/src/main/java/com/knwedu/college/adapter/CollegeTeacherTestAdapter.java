...
import com.knwedu.college.CollegeTeacherTestResultsActivity;
...
public class CollegeTeacherTestAdapter extends BaseAdapter {
	ViewHolder holder;
	...
	public CollegeTeacherTestAdapter(Context context,
			ArrayList<Assignment> assignments, Subject subject,
			int type_variable_assignment, boolean isOnline, String page,
			String type_permission_mark) {
