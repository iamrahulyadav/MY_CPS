...
public class CollegeSyllabusAdapter extends BaseExpandableListAdapter {
	ViewHolder holder;
	...
	public CollegeSyllabusAdapter(Context context, ArrayList<String> terms,HashMap<String,ArrayList<String>> hashmapVal) {
