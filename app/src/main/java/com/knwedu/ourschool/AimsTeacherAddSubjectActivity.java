...
public class AimsTeacherAddSubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = AimsTeacherAddSubjectActivity.this;
        initialize();
    }
    ...
    private void initialize() {
        ...
        nameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(AimsTeacherAddSubjectActivity.this,
                Constants.UORGANIZATIONID)));
    ...
    private class SetClassListAsyn extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            JSONObject json = jParser.getJSONFromUrlfrist(namevaluepair, SchoolAppUtils.GetSharedParameter(
    ...
    private class SetSubjectListAsync extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        String error = "";
    ...
    private class AddSubjectAsyntask extends AsyncTask<List<NameValuePair>, Void, Boolean> {
