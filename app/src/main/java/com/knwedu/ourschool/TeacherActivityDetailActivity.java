...
public class TeacherActivityDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SchoolAppUtils.loadAppLogo(TeacherActivityDetailActivity.this,
    ...
    private void initialize() {
        ...
        if (getIntent().getExtras() != null) {
            if (internetAvailable) {
                ...
                test = mDatabase.getAssignment(row_id, 3);
                mDatabase.close();
            }
        ...
        addResult.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(TeacherActivityDetailActivity.this,
        ...
        if (internetAvailable) {
            if ((SchoolAppUtils.GetSharedParameter(
                    TeacherActivityDetailActivity.this,
        ...
        if (!test.file_name.equals("null") && !test.attachment.equals("null")
            ...
            getdoc.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    new AlertDialog.Builder(TeacherActivityDetailActivity.this)
                            ...
                            .setNegativeButton("Download",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(
                                            ...
                                            final DownloadTask downloadTask = new DownloadTask(TeacherActivityDetailActivity.this, test.file_name);
    ...
    private class UploadAsyntask extends
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(TeacherActivityDetailActivity.this);
            ...
            if (result) {
                ...
                dialoggg.setNeutralButton(R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                TeacherActivityDetailActivity.this.finish();
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(
                            TeacherActivityDetailActivity.this, page_title, error);
                } else {
                    SchoolAppUtils.showDialog(
                            TeacherActivityDetailActivity.this, page_title,
