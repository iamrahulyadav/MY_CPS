...
public class ClassFellowSectionListActivity extends AppCompatActivity {
    ...
    OnItemClickListener listener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Intent intent = new Intent(ClassFellowSectionListActivity.this, TeacherBehaviourListActivity.class);
            intent.putExtra(Constants.IS_ONLINE, internetAvailable);
            intent.putExtra(Constants.PAGE_TITLE, "Class Fellow");
            if (internetAvailable) {
                intent.putExtra(Constants.TANNOUNCEMENT, subject.object.toString());
                intent.putExtra(Constants.CLASSFELLOW, fellows.get(arg2).object.toString());
            } else {
