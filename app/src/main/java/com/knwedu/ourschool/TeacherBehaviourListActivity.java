...
public class TeacherBehaviourListActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (temp != null) {
                ...
                String tempclassfellow = getIntent().getExtras().getString(Constants.CLASSFELLOW);
                if (temp != null) {
            ...
            addAssignment.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    Intent intent = new Intent(TeacherBehaviourListActivity.this,
                    ...
                    intent.putExtra(Constants.CLASSFELLOW, class_fellow.object.toString());
    ...
    private void handleMonthlyWeekly() {
        if (SchoolAppUtils.GetSharedBoolParameter(TeacherBehaviourListActivity.this,
