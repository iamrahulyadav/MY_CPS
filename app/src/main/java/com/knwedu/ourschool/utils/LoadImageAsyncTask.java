...
public class LoadImageAsyncTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    public LoadImageAsyncTask(Context context, ImageView imageView, String base_url,
...
//			imageView.setImageBitmap(result);
            ...
            result = BitmapFactory.decodeResource(context.getResources(), R.drawable.profile);
        }
