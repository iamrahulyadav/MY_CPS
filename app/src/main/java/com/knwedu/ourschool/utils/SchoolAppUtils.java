...
public class SchoolAppUtils {
    ...
    public static void SetSharedParameter(Context context, String key, String value) {
        preferences = context.getSharedPreferences(SchoolAppUtils.SHARED_PREFERENCES_NAME, SchoolAppUtils.SHARED_PREFERENCES_MODE);
	...
	*/
    ...
    public static void viewDocument(final Context context, String url) {
    ...
    public static void imagePdfViewDocument(final Context context, String url, String fileName) {
        ...
        if (extension.equals(".png") || extension.equals(".jpg") || fileName.substring(fileName.length() - 5).equals(".jpeg")) {
    ...
    public static void loadAppLogo(Context context, ImageButton button) {
        ContextWrapper cw = new ContextWrapper(context);

        File directory = cw.getDir("imageDir", Context.MODE_PRIVATE);
        // Create imageDir
        File path = new File(directory, "footer_logo.png");
        //-----------------------------------------------------------------
        if (button != null) {
            Drawable d = Drawable.createFromPath(path.getAbsolutePath());
            button.setImageDrawable(d);
        }
//		button.setCompoundDrawablesWithIntrinsicBounds( d, null, null, null);
//		button.setText(SchoolAppUtils.GetSharedParameter(context, Constants.PUSH_TITLE));
    }
    ...
    public static void deleteTutorialFiles(Context context) {
    ...
    public static int countTutorialFiles(Context context) {
        File root = new File(context.getFilesDir().getPath());
        File[] Files = root.listFiles(new FilenameFilter() {
