...
public class DataStructureFramwork {
	...
	public static class UserInfo {
		...
		public UserInfo(JSONObject c) {
			...
			try {
				...
				Log.e("user_id", c.getString("user_id").trim());
			} catch (Exception e) {
			}
			try {
				this.usertypeid = c.getString("user_type_id").trim();
				Log.e("user_type_id", c.getString("user_type_id").trim());
			} catch (Exception e) {
			}
			try {
				this.organizationid = c.getString("organization_id").trim();
				Log.e("organization_id", c.getString("organization_id").trim());
			} catch (Exception e) {
			}
			try {
				this.paystatus = c.getString("pay_status").trim();
				Log.e("pay_status", c.getString("pay_status").trim());
			} catch (Exception e) {
			}
			try {
				this.alt_email = c.getString("alt_email").trim();
				Log.e("alt_email", c.getString("alt_email").trim());
			} catch (Exception e) {
			}
			try {
	...
	public static class Subject {
		...
		public Subject(JSONObject c) {
			...
			try {
				...
				Log.e("section_id", c.getString("section_id").trim());
			} catch (Exception e) {
			}
			try {
	...
	public static class Assignment {
		...
		public Assignment(JSONObject c) {
			...
			try {
				this.id = c.getString("id").trim();
				Log.e("id_____", c.getString("id").trim());
			} catch (Exception e) {
			}
			try {
...
//						+ c.getString("lname").trim();
	...
	public static class TeacherProfileInfo {
		...
		public TeacherProfileInfo(JSONObject c) {
			...
			try {
				this.alt_email = c.getString("alt_email").trim();
				Log.e("alt_email", this.alt_email);
			} catch (Exception e) {
			}
			try {
				this.image = c.getString("image").trim();
			...
			try {
				this.mname = c.getString("mname").trim();
				Log.e("mname", this.mname);
			} catch (Exception e) {
			}
			try {
				this.lname = c.getString("lname").trim();
				Log.e("lname", this.lname);
			} catch (Exception e) {
			}
			try {
				this.pincode = c.getString("pin_code").trim();
	...
	public static class StudentProfileInfo {
		...
		public StudentProfileInfo(JSONObject c) {
			...
			try {
				this.user_code = c.getString("user_code").trim();
				Log.e("user_code", this.user_code);
			} catch (Exception e) {
			}
			try {
				this.fullname = c.getString("fname").trim() + " "
			...
			try {
				...
				;
				Log.e("class_name", this.class_section);
			} catch (Exception e) {
			}
			try {
				this.class_roll = c.getString("roll_no").trim();
				Log.e("class_roll", this.class_roll);
			} catch (Exception e) {
			}
			try {
				this.email = c.getString("email").trim();
			...
			try {
				this.mobile_no = c.getString("mobile_no").trim();
				Log.e("mobile_number", this.mobile_no);
			} catch (Exception e) {
			}
			try {
				this.address = c.getString("address").trim();
			...
			try {
				this.religion = c.getString("religion").trim();
				Log.e("religion", this.religion);
			} catch (Exception e) {
			}

			try {
				this.blood_group = c.getString("blood_group").trim();
				Log.e("blood_group", this.blood_group);
			} catch (Exception e) {
			}

			try {
				this.ailment = c.getString("ailment").trim();
				Log.e("ailment", this.ailment);
			} catch (Exception e) {
			}

			try {
				this.hostel = c.getString("name").trim();
				Log.e("hostel", this.hostel);
			} catch (Exception e) {
			}
			try {
				this.transport = c.getString("route").trim();
				Log.e("transport", this.transport);
			} catch (Exception e) {
			}
			try {
				this.image = c.getString("image").trim();
			...
			try {
				this.alt_email = c.getString("alt_email").trim();
				Log.e("blood_group", this.alt_email);
			} catch (Exception e) {
			}
...
//			}
			try {
				...
				Log.e("pincode", c.getString("pincode").trim());
			} catch (Exception e) {
			}
			try {
				this.section_id = c.getString("section_id").trim();
	...
	public static class PermissionAdd {
		...
		public PermissionAdd(JSONObject c) {
			...
			try {
				...
				Log.e("assignment_add", c.getString("assignment_add").trim());
			} catch (Exception e) {
			}
			try {
				this.test_add = c.getString("test_add").trim();
				Log.e("test_add", c.getString("test_add").trim());
			} catch (Exception e) {
			}
			try {
				this.activity_add = c.getString("activity_add").trim();
				Log.e("activity_add", c.getString("activity_add").trim());
			} catch (Exception e) {
			}
			try {
				this.announcement_add = c.getString("announcement_add").trim();
				Log.e("announcement_add", c.getString("announcement_add")
						.trim());
			} catch (Exception e) {
			}
			try {
				this.classwork_add = c.getString("classwork_add").trim();
				Log.e("activity_add", c.getString("classwork_add").trim());
			} catch (Exception e) {
			}
			try {
				this.lessons_add = c.getString("lessons_add").trim();
				Log.e("lessons_add", c.getString("lessons_add").trim());
			} catch (Exception e) {
			}

			try {
				this.attendance_type = c.getString("attendance_type").trim();
				Log.e("attendace_type", c.getString("attendace_type").trim());
			} catch (Exception e) {
			}
		}
