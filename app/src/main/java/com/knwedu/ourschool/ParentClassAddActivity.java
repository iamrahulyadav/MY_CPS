...
public class ParentClassAddActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_parent_class_add);
		initialize();
	}
	...
	private void initialize() {
		...
		nameValuePairs.add(new BasicNameValuePair("org_id", SchoolAppUtils
				.GetSharedParameter(ParentClassAddActivity.this,
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (selected_section_id.equals("0")) {
					SchoolAppUtils.showDialog(ParentClassAddActivity.this,
	...
	private class SetClassListAsyn extends
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = new ProgressDialog(ParentClassAddActivity.this);
			dialog.setTitle(getResources().getString(R.string.fetch_classes));
		...
		protected Boolean doInBackground(List<NameValuePair>... params) {
			...
			JSONObject json = jParser.getJSONFromUrlfrist(
					namevaluepair,
					SchoolAppUtils.GetSharedParameter(
							ParentClassAddActivity.this, Constants.COMMON_URL)
				...
				alert.setNeutralButton(R.string.ok,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface arg0, int arg1) {
								ParentClassAddActivity.this.finish();
