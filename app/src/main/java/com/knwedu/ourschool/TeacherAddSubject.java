...
public class TeacherAddSubject extends AppCompatActivity {
        ...
        save_subject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selected_section_id.equals("0")) {
                    SchoolAppUtils.showDialog(TeacherAddSubject.this,
                            "Add Subject",
                ...
                addNameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils
                        .GetSharedParameter(TeacherAddSubject.this,
    ...
    private class SetClassListAsyn extends
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(TeacherAddSubject.this);
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            JSONObject json = jParser.getJSONFromUrlfrist(
                    ...
                    SchoolAppUtils.GetSharedParameter(
                            TeacherAddSubject.this, Constants.COMMON_URL)
                                        ...
                                        .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                            ...
                                            public void onItemSelected(
                                                ...
                                                if (n > 0) {
                                                    ...
                                                    nameValuePairs.add(new BasicNameValuePair("teacher_id", SchoolAppUtils.GetSharedParameter(TeacherAddSubject.this, Constants.USERID)));
                                                    nameValuePairs.add(new BasicNameValuePair("section_id", selected_section_id));
                                                    nameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(TeacherAddSubject.this, Constants.UORGANIZATIONID)));
