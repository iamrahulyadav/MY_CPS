...
public class ParentMainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //--------------premium service----------
        appType = SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.APP_TYPE);
        if (SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.PREMIUM_SERVICE_AVAILABLE).equalsIgnoreCase("1")) {
        ...
        menuRightButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isExpanded) {
                    ...
                    fragmentManager.beginTransaction().replace(R.id.menuPanel, new RightMenuFragment()).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN).commit();
                    new ExpandAnimation(mainlayout, panelWidth, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, -0.75f, 0, 0.0f, 0, 0.0f);
                } else {
                    isExpanded = false;
                    // Collapse
                    mainlayout.setBackgroundResource(R.drawable.profile_bg);
                    new CollapseAnimation(mainlayout, panelWidth, TranslateAnimation.RELATIVE_TO_SELF, -0.75f, TranslateAnimation.RELATIVE_TO_SELF, 0.0f, 0, 0.0f, 0, 0.0f);
                }
            }
        });
    }
    ...
    private void selectItem(int position) {
        ...
        if (label.equalsIgnoreCase(Constants.MENU_PARENT_CHILD_PROFILE)) {
            ...
            // -----------------Academics-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new SubjectListFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_CLASS_FELLOW)) {
            // ----------------Class Fellow------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ClassFellowFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        }
        //TODO- Weekly PLan
            ...
            // -----------------Weekly plan-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new SubjectListFragmentWeeklyPlan()).commit();
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        }
        //TODO- Lesson PLan
            ...
            // -------------------Lesson Plan---------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new SubjectListFragmentLessonPlan()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_TIME_TABLE)) {
            // ------------------Time Table----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ClassFacilitiesListFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_BEHAVIOUR)) {
            // -------------------Organization---------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new StudentBehaviourListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_ASSIGNMENT)) {
            // -----------------Assignment-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AssignmentListFragment(1)).commit();
            showMonthWeek.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.month_and_week_btn),
                    null, null, null);
            ...
            // -----------------Quiz-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AssignmentListFragment(2)).commit();
            showMonthWeek.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.month_and_week_btn),
                    null, null, null);
            ...
            // -------------------Activity---------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AssignmentListFragment(3)).commit();
            showMonthWeek.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.month_and_week_btn),
                    null, null, null);
            ...
            // -----------------Exam-----------------------
            if (appType.equals(Constants.APP_TYPE_COMMON_STANDARD)) {
                fragmentManager.beginTransaction().replace(R.id.content_frame, new AisExamScheduleFragments()).commit();
            } else {
                fragmentManager.beginTransaction().replace(R.id.content_frame, new ExamsListFragment()).commit();
            }
            ...
            // ------------------Course work----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AnnouncementListFragment(1)).commit();
            ...
            // ----------------Announcement------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AnnouncementListFragment(2)).commit();

            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_BULLETINS)) {
            // -----------------Bulletins-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new BulletinListFragment()).commit();

            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_ORGANIZATION)) {
            // ----------------Organization------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new OrganizationListFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_ATTENDANCE_INFO)) {
            // ----------------Attendance Info------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new AttendanceViewFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_DIRECTORY)) {
            // ----------------Directory------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new SchoolInfoFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_REQUEST)) {
            // ------------------Requests----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ParentRequestFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_CHILDREN)) {
            // -----------------Children-----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ParentChildrenListFragment()).commit();

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_MY_PROFILE)) {
            // ------------------My Profile----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ParentProfileFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);

        } else if (label.equalsIgnoreCase(Constants.MENU_PARENT_BLOG)) {
            // ------------------Blog----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new BlogListFragment()).commit();
            ...
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_WEBACCESS)) {
            // ----------------Web Access------------------------
            ...
            if (appType.equals(Constants.APP_TYPE_COMMON_STANDARD)) {
                ...
                if (SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.NEWTRANSPORT_TYPE).equals("Y")) {
                    fragmentManager.beginTransaction().replace(R.id.content_frame, new AisTransportFragment()).commit();
                } else {
            ...
            // -------------------Daily Diary---------------------
            if (appType.equals(Constants.APP_TYPE_COMMON_STANDARD)) {
                fragmentManager.beginTransaction().replace(R.id.content_frame, new AisDailyDiaryListFragment()).commit();

            } else {
                fragmentManager.beginTransaction().replace(R.id.content_frame, new DailyDiaryParentFragment()).commit();
            }
            showMonthWeek.setVisibility(View.GONE);
            btnAdd.setVisibility(View.GONE);
            ...
            builder.setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            if (SchoolAppUtils.isOnline(ParentMainActivity.this)) {
                                SchoolAppUtils.SetSharedBoolParameter(ParentMainActivity.this, Constants.ISPARENTSIGNIN, false);
                                SchoolAppUtils.SetSharedBoolParameter(ParentMainActivity.this, Constants.UISSIGNIN, false);

                                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(3);
                                nameValuePairs.add(new BasicNameValuePair("user_type_id", SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.USERTYPEID)));
                                nameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.UORGANIZATIONID)));
                                nameValuePairs.add(new BasicNameValuePair("user_id", SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.USERID)));
                                new Signout().execute(nameValuePairs);
                            } else {
                                SchoolAppUtils.SetSharedParameter(ParentMainActivity.this, Constants.USERID, "0");
                                finish();
                                startActivity(new Intent(ParentMainActivity.this, SigninActivity.class));
                            }
        ...
        } else if (label.equalsIgnoreCase(Constants.MENU_STUDENT_CHALLENGE)) {

            UserClass userClass = Util.fetchUserClass(ParentMainActivity.this);
            if (userClass == null)
                userClass = new UserClass();

            if (userClass.challengeUrl != null && userClass.challengeUrl.length() > 0) {
                /*Intent intent = new Intent(MainActivity.this, KnwEduChallengeActivity.class);
                intent.putExtra("challengeUrl", "" + userClass.challengeUrl);
                startActivity(intent);*/
                String url = "" + userClass.challengeUrl;
               ...
               /* Intent intent = new Intent(MainActivity.this, KnwEduChallengeActivity.class);
                ...
                startActivity(intent);*/
                String url = "https://www.knwedu.com/challenge";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
    ...
    protected void onResume() {
        super.onResume();
        if (SchoolAppUtils.GetSharedBoolParameter(ParentMainActivity.this, "showannouncements")) {
            SchoolAppUtils.SetSharedBoolParameter(ParentMainActivity.this, "showannouncements", false);
            button.setImageResource(R.drawable.menu_icon);
            adapter.showAnnouncements();
            adapter.notifyDataSetChanged();
        }
        if (SchoolAppUtils.GetSharedBoolParameter(ParentMainActivity.this, "shownews")) {
            SchoolAppUtils.SetSharedBoolParameter(ParentMainActivity.this, "shownews", false);
            button.setImageResource(R.drawable.menu_icon);
            adapter.showNews();
            adapter.notifyDataSetChanged();
        }
    ...
    private class MenuAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            } else if (tags[position].equalsIgnoreCase(Constants.MENU_STUDENT_CHALLENGE)) {
            ...
            if (tags[position].equals(Constants.MENU_PARENT_CHILDREN)) {
                ...
                // holder.btnNotificationBubble.setVisibility(View.GONE);
            } else if (tags[position].equals(Constants.MENU_WEBACCESS)) {
    ...
    class Signout extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                Toast.makeText(ParentMainActivity.this, error, Toast.LENGTH_LONG).show();
                SchoolAppUtils.SetSharedParameter(ParentMainActivity.this, Constants.USERID, "0");
                UserClass userClass = Util.fetchUserClass(ParentMainActivity.this);
                userClass.setOTPSignup(false);
                Util.saveUserClass(ParentMainActivity.this, userClass);
                startActivity(new Intent(ParentMainActivity.this, SigninActivity.class));
                finish();
            } else {
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(ParentMainActivity.this, "Sign Out", error);
                } else {
                    SchoolAppUtils.showDialog(ParentMainActivity.this, "Sign Out", getResources().getString(R.string.unknown_response));
                }
            }
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            JSONObject json = jParser.getJSONFromUrlnew(nameValuePairs, Urls.api_signout);
            try {
    ...
    public void checkForPremimumService() {
        ...
        nameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.UORGANIZATIONID)));
        nameValuePairs.add(new BasicNameValuePair("student_id", SchoolAppUtils.GetSharedParameter(ParentMainActivity.this, Constants.CHILD_ID)));
    ...
    private class RequestPremiumServiceStatusAsyntask extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(ParentMainActivity.this, ParentMainActivity.this.getTitle().toString(), error);
                } else {
                    SchoolAppUtils.showDialog(ParentMainActivity.this, ParentMainActivity.this.getTitle().toString(), getResources().getString(R.string.error));
                }
    ...
    public void popUpView() {
        ...
        if (Util.fetchUserClass(ParentMainActivity.this).getSignupType().equalsIgnoreCase(StaticConstant.NORMAL_SIGNUP)) {
            View promptView = layoutInflater.inflate(R.layout.message_prompt_layout_normal_signup, null);
    ...
    */
    ...
    public void notifyUser() {
        ...
        } else if (SchoolAppUtils.GetSharedBoolParameter(this, Constants.ISPARENTSIGNIN) == true) {
            notificationIntent = new Intent(this, SplashActivity.class);
        } else if (SchoolAppUtils.GetSharedBoolParameter(this, Constants.ISSIGNIN) == true) {
            notificationIntent = new Intent(this, SplashActivity.class);
        } else {
            notificationIntent = new Intent(this, SplashActivity.class);
        }
        try {
            ...
            Notification notification = new Notification(R.drawable.app_icon, "Want to track your child’s transport. Kindly subscribe from ‘Transport’ section\"", when);
