	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.mnLayout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(context, TeacherTestDetailActivity.class);
		...
		holder.mark.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case 1:
					intent = new Intent(context, TeacherAssignmentResultsActivity.class);
					break;
				case 2:
					intent = new Intent(context, TeacherTestResultsActivity.class);
					break;
				case 3:
					intent = new Intent(context, TeacherActivityResultsActivity.class);
					break;
