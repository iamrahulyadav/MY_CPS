...
public class AisSyllabus extends Fragment {
    private View view;
    ...
    private class GetSyllabusAsyntask extends
                ...
                if (json != null) {
                    if (json.getString("result").equalsIgnoreCase("1")) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            AisSyllabusData mSyllabus = new AisSyllabusData(array.getJSONObject(i));
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                adapter = new AisSyllabusAdapter(getActivity(), mlistSyllabus, 1);
