...
public class RequestToParentFragment extends Fragment {
    ...
    private CardView cv_class, cv_me;
    ...
    private void initialize() {
      ...
      /*  btnClass = (Button) view.findViewById(R.id.request_class);
        ...
        cv_class = (CardView) view.findViewById(R.id.cv_class);
        cv_me = (CardView) view.findViewById(R.id.cv_me);


        cv_class.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), RequestToParentForClassActivity.class);
                intent.putExtra("type", 1);
                startActivity(intent);
            }
        });

        cv_me.setOnClickListener(new OnClickListener() {
