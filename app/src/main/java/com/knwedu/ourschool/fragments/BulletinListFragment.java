...
//				}
        ...
        type = SchoolAppUtils.GetSharedParameter(getActivity(), Constants.USERTYPEID);
        /*
		 * if(type.equals("3")){
		 * 
		...
		/* } */
        ArrayAdapter<String> data = new ArrayAdapter<String>(getActivity(), R.layout.simple_spinner_item_custom_new, temp);
