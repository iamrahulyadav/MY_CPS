...
public class SynchronizeFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.sync, container, false);
		initialize();
		return view;
	}

	private void initialize() {
		mDatabase = ((SchoolApplication) getActivity().getApplicationContext()).getDatabase();
