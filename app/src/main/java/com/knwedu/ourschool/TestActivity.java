...
public class TestActivity extends AppCompatActivity {
    private TextView title, assignmentText, duaDate, header, marks, comments, assigned_marks, comment_main_txt,
            lbl_submission, lbl_assigned, sub_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SchoolAppUtils.loadAppLogo(TestActivity.this, (ImageButton) findViewById(R.id.app_logo));
    ...
    private void initialize() {
        ...
        if (SchoolAppUtils.GetSharedParameter(TestActivity.this,
        ...
        if (getIntent().getExtras() != null) {
            assignment_type = getIntent().getIntExtra(
                    Constants.ASSIGNMENT_TYPE, 2);
            String temp = getIntent().getExtras().getString(Constants.TEST);
                                ...
                                .setNegativeButton("Download",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(
                                                ...
                                                final DownloadTask downloadTask = new DownloadTask(TestActivity.this, assignment.file_name);
            ...
            if (assignment.is_published.equals("1")) {
                ...
                graphBtn.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        Intent intent = new Intent(TestActivity.this, GraphViewActivity.class);
