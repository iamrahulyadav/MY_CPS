...
public class TeacherMainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appType = SchoolAppUtils.GetSharedParameter(TeacherMainActivity.this, Constants.APP_TYPE);
    ...
    private void selectItem(int position) {
        ...
        if (label.equalsIgnoreCase(Constants.MENU_TEACHER_MY_PROFILE)) {
            // ----------------Profile------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherProfileFragment()).commit();
            ...
            // ------------------Attendance----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherSubjectAttendanceListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_TEACHER_ASSIGNMENT)) {
            // ----------------Assignment------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherAssignmentListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_TEACHER_QUIZ)) {
            // ------------------Quiz----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherTestListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_TEACHER_ACTIVITY)) {
            // ----------------Activity------------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherActivityListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_TEACHER_ANNOUNCEMENT)) {
            // ------------------Announcement----------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TeacherAnnouncementListFragment()).commit();
            showMonthWeek.setVisibility(View.GONE);
        } else if (label.equalsIgnoreCase(Constants.MENU_STUDENT_BEHAVIOUR)) {
            // -------------------Behaviour---------------------
            fragmentManager.beginTransaction().replace(R.id.content_frame, new BehaviourListFragment())
                    .commit();
            showMonthWeek.setVisibility(View.GONE);
            ...
            UserClass userClass = Util.fetchUserClass(TeacherMainActivity.this);
            if (userClass == null)
    ...
    private class MenuAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (tags[position].equals(Constants.MENU_TEACHER_MY_PROFILE)) {
                ...
                //holder.btnNotificationBubble.setVisibility(View.GONE);
            } else if (tags[position].equals(Constants.MENU_TEACHER_SYNCHRONIZE)) {
    ...
    class Signout extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                Toast.makeText(TeacherMainActivity.this, error, Toast.LENGTH_LONG).show();
                SchoolAppUtils.SetSharedParameter(TeacherMainActivity.this, Constants.USERID, "0");

                UserClass userClass = Util.fetchUserClass(TeacherMainActivity.this);
                userClass.setOTPSignup(false);
                Util.saveUserClass(TeacherMainActivity.this, userClass);
                startActivity(new Intent(TeacherMainActivity.this, SigninActivity.class));
                finish();
            } else {
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(TeacherMainActivity.this, "Sign Out", error);
                } else {
                    SchoolAppUtils.showDialog(TeacherMainActivity.this, "Sign Out", getResources().getString(R.string.error));
                }
            }
    ...
    public void popUpView() {
        ...
        if(Util.fetchUserClass(TeacherMainActivity.this).getSignupType().equalsIgnoreCase(StaticConstant.NORMAL_SIGNUP)) {
