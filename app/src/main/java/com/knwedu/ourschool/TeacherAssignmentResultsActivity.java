...
public class TeacherAssignmentResultsActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void initialize() {
        ...
        if (assignment != null) {
            ...
            if (internetAvailable) {
                ...
                nameValuePairs.add(new BasicNameValuePair("id", assignment.id));
    ...
    private class UploadAsyntask extends
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(TeacherAssignmentResultsActivity.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                dialoggg = new AlertDialog.Builder(
                        TeacherAssignmentResultsActivity.this);
                ...
                dialoggg.setNeutralButton(R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                TeacherAssignmentResultsActivity.this.finish();
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(TeacherAssignmentResultsActivity.this, page_title, error);
                } else {
                    SchoolAppUtils.showDialog(TeacherAssignmentResultsActivity.this, page_title,
    ...
    private void addView(String name, String nums, final int num) {
        ...
        final LinearLayout row = (LinearLayout) inflater.inflate(R.layout.teacher_result_item, null);
                        ...
                        if (marks.length() > 0) {
                            ...
                            try {
                                if (Double.parseDouble(arg0.toString()) > Double
                                        .parseDouble(assignment.total_marks)) {
                                    ((EditText) row
        ...
        if (SchoolAppUtils.GetSharedParameter(
                TeacherAssignmentResultsActivity.this, Constants.USERTYPEID)
                .equalsIgnoreCase("3")) {
        ...
        ((ImageButton) row.findViewById(R.id.comment_btn))
                .setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialogCustom = new Dialog(TeacherAssignmentResultsActivity.this);
                        dialogCustom.requestWindowFeature(Window.FEATURE_NO_TITLE);
                        dialogCustom.setContentView(R.layout.add_comments_dialog);
                        if (students.get(num).comment != null) {
                            if (students.get(num).comment.length() > 0) {
                                ((EditText) dialogCustom.findViewById(R.id.comments_edt)).setText(students.get(num).comment);
                            }
                        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.submit_btn) {
            ...
            for (int i = 0; i < students.size(); i++) {
                if (Double.parseDouble(students.get(i).total_marks) > (Double
                        .parseDouble(assignment.total_marks) + 1)) {
                ...
                hash.put(students.get(i).id,
                        students.get(i).total_marks);
            }
            ...
            for (int i = 0; i < students.size(); i++) {
                ...
                hash_com.put(students.get(i).id,
            ...
            nameValuePairs.add(new BasicNameValuePair("id",
                    assignment.id));
            nameValuePairs.add(new BasicNameValuePair("marks_info",
                    hash.toString()));
            nameValuePairs.add(new BasicNameValuePair("comments_info",
                    hash_com.toString()));
