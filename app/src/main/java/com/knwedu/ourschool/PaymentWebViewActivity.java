...
import com.knwedu.ourschool.ccavenue.RSAUtility;
...
public class PaymentWebViewActivity extends Activity {
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(PaymentWebViewActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            //params.add(new BasicNameValuePair(AvenuesParams.MERCHANT_PARAM1, mainIntent.getStringExtra(AvenuesParams.MERCHANT_PARAM1)));
            //params.add(new BasicNameValuePair(AvenuesParams.MERCHANT_PARAM2, mainIntent.getStringExtra(AvenuesParams.MERCHANT_PARAM2)));
        ...
        protected void onPostExecute(Void result) {
                    ...
                    builder.setPositiveButton("Ok",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    /*if(mainIntent.getStringExtra("callType").equals("aims")) {
                                        AimsPaymentFeeDetailsActivity.self_intent.finish();
                                    }*/
                                    finish();
                                }
                            });
            ...
            webview.setWebViewClient(new WebViewClient(){
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    Log.d("intent","intent");
                    /*if(mainIntent.getStringExtra("callType").equals("aims")) {
                        if (url.indexOf("/ccavResponseHandlerAIMS") != -1) {
                            webview.loadUrl("javascript:window.HTMLOUT.processHTML('<head>'+document.getElementsByTagName('html')[0].innerHTML+'</head>');");
                        }
                    }else{*/
                        if (url.indexOf("/ccavResponseHandlerAIS") != -1) {
                            webview.loadUrl("javascript:window.HTMLOUT.processHTML('<head>'+document.getElementsByTagName('html')[0].innerHTML+'</head>');");
                        }
                    //}
                }
