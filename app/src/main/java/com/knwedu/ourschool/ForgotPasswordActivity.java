	...
	private class SendPasswordAsyntask extends
		...
		protected void onPostExecute(Boolean result) {
			...
			if (result) {
				...
				if (error != null) {
					if (error.length() > 0) {
						SchoolAppUtils.showDialog(ForgotPasswordActivity.this, getTitle().toString(), error);
					} else {
						SchoolAppUtils.showDialog(ForgotPasswordActivity.this, getTitle().toString(), getResources().getString(R.string.please_check_internet_connection));
					}
				} else {
					SchoolAppUtils.showDialog(ForgotPasswordActivity.this, getTitle().toString(), getResources().getString(
