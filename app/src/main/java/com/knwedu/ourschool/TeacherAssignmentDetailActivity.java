...
public class TeacherAssignmentDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SchoolAppUtils.loadAppLogo(TeacherAssignmentDetailActivity.this,
    ...
    private void initialize() {
        ...
        addResult.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(
                        TeacherAssignmentDetailActivity.this,
        ...
        if (internetAvailable) {
            ...
            } else if (assignment.total_marks.equalsIgnoreCase("0")) {
                addResult.setVisibility(View.INVISIBLE);
                marks.setVisibility(View.INVISIBLE);
                findViewById(R.id.title_marks_txt)
                        .setVisibility(View.INVISIBLE);
        ...
        if (!assignment.file_name.equals("null")
                && !assignment.attachment.equals("null") && internetAvailable) {
                            ...
                            .setNegativeButton("Download",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(
                                                ...
                                                int which) {
                                            // download
                                            final DownloadTask downloadTask = new DownloadTask(TeacherAssignmentDetailActivity.this, assignment.file_name);
    ...
    private class UploadAsyntask extends
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(TeacherAssignmentDetailActivity.this);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                dialoggg.setNeutralButton(R.string.ok,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                TeacherAssignmentDetailActivity.this.finish();
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(TeacherAssignmentDetailActivity.this, page_title, error);
                } else {
                    SchoolAppUtils.showDialog(TeacherAssignmentDetailActivity.this, page_title,
