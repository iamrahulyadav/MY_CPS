...
public class AimsRegistrationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageLoader.getInstance().displayImage(ais_logo_url, logo_image, options);

        lnStudent.setVisibility(View.GONE);

        mStudentList.add("Select Student");
        ArrayAdapter<String> adapterClassStudent = new ArrayAdapter<String>(AimsRegistrationActivity.this, R.layout.simple_spinner_dropdown_item_custom, mStudentList);
        adapterClassStudent.setDropDownViewResource(R.layout.simple_spinner_dropdown_item_custom_new);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int errorCount = 0;
                if (!SchoolAppUtils.isValidEmail(email.getText().toString())) {
                ...
                if (user_type_id.equals("5")) {
                    if (selected_stu_sub_id.equals("0")) {
                        ...
                        Toast.makeText(AimsRegistrationActivity.this, "Select Student", Toast.LENGTH_LONG).show();
                        errorCount++;
                    }
                }
                if (user_type_id.equals("4")) {
                    if (selected_stu_sub_id.equals("0")) {
                        ...
                        Toast.makeText(AimsRegistrationActivity.this, "Select Students", Toast.LENGTH_LONG).show();
                        errorCount++;
                    }
                }
                ...
                if (user_type_id.equals("3")) {
                    if (selected_stu_sub_id.equals("0")) {
                        ...
                        Toast.makeText(AimsRegistrationActivity.this, "Select Subject", Toast.LENGTH_LONG).show();
                        errorCount++;
                    }
                }
                if (selected_section_id.equals("0")) {

                    Toast.makeText(AimsRegistrationActivity.this, "Select valid Class & Section", Toast.LENGTH_LONG).show();
                    errorCount++;
                }
                ...
                if (errorCount == 0) {
                    ...
                    nvp.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.UORGANIZATIONID)));
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.radio_teacher:
                ...
                ArrayAdapter<String> adapterClassSubject = new ArrayAdapter<String>(AimsRegistrationActivity.this, R.layout.simple_spinner_dropdown_item_custom, mSubjectList);
                adapterClassSubject.setDropDownViewResource(R.layout.simple_spinner_dropdown_item_custom_new);
    ...
    private class SetClassListAsyn extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ProgressDialog dialog;
        String error = "";
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            JSONObject json = jParser.getJSONFromUrlfrist(namevaluepair, SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_class_section_list);
            try {
                ...
                if (json != null) {
                    if (json.getString("result").equalsIgnoreCase("1")) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            DataStructureFramwork.ClassOfOrg classOfOrg = new DataStructureFramwork.ClassOfOrg(array.getJSONObject(i));
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                ArrayAdapter<String> adapterClass = new ArrayAdapter<String>(AimsRegistrationActivity.this, R.layout.simple_spinner_dropdown_item_custom, mList);
                adapterClass.setDropDownViewResource(R.layout.simple_spinner_dropdown_item_custom_new);
                spinnerClass.setAdapter(adapterClass);

                spinnerClass.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

                    @Override
                    public void onItemSelected(AdapterView<?> arg0, View arg1, int n, long arg3) {
                        ArrayList<String> mList = new ArrayList<String>();
                        if (aliestype.equalsIgnoreCase("college")) {
                        ...
                        if (n > 0) {
                            ...
                            for (int i = 0; i < classOfOrg.section_List.size(); i++) {
                                mList.add(classOfOrg.section_List.get(i).section_name);
                            }
                        ...
                        spinnerSection.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> arg0, View arg1, int n, long arg3) {
                                if (n > 0) {
                                    selected_section_id = classes.get(spinnerClass.getSelectedItemPosition() - 1).section_List.get(n - 1).section_id;
                                    selected_class_id = classes.get(spinnerClass.getSelectedItemPosition() - 1).class_id;
                                    List<NameValuePair> nvp = new ArrayList<NameValuePair>();
                                    nvp.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.UORGANIZATIONID)));
                                    nvp.add(new BasicNameValuePair("section_id", selected_section_id));
                                    ...
                                    ArrayAdapter<String> adapterClass = new ArrayAdapter<String>(AimsRegistrationActivity.this, R.layout.simple_spinner_dropdown_item_custom, mssList);
                                    adapterClass.setDropDownViewResource(R.layout.simple_spinner_dropdown_item_custom_new);
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(AimsRegistrationActivity.this, "Registration", error);
                } else {
                    SchoolAppUtils.showDialog(AimsRegistrationActivity.this, "Registration", getResources().getString(R.string.error));
                }
            }
    ...
    public class GetStudentSubjects extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            JsonParser jParser = new JsonParser();
            if (user_type_id.equals("5")) {
                url = SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_get_student;
            } else if (user_type_id.equals("4")) {

                url = SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_get_student_new;
            } else {
                url = SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_get_subject;
            }
            JSONObject json = jParser.getJSONFromUrlfrist(namevaluepair, url);
            try {
                if (json != null) {
                    if (json.getString("result").equalsIgnoreCase("1")) {
                        JSONArray array;
    ...
    private class RegisterUserAsync extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ProgressDialog dialog;
        String error = "";
        String message = "";
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            register_url = SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_register;
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                dialoggg = new AlertDialog.Builder(AimsRegistrationActivity.this);
        ...
        private class SignInAsyntask extends AsyncTask<List<NameValuePair>, Void, Boolean> {
                ...
                try {
                    ...
                    if (json != null) {
                        if (json.getString("result").equalsIgnoreCase("1")) {
                            ...
                            String menu_tag;
                            String menu_title;
                            if (SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.APP_TYPE).equals(Constants.APP_TYPE_COMMON_STANDARD)) {
                            ...
                            if (orgConfigJSONObj != null) {
                                ...
                                try {
                                    ...
                                    SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.INSURANCE_AVIALABLE, isInsuranceAvailable);

                                    SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.PREMIUM_SERVICE_AVAILABLE, isPremiumServiceAvailable);

                                    SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.NEWTRANSPORT_TYPE, transportType);
                            ...
                            if (object != null) {
                                ...
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.USERTYPEID, userInfo.usertypeid);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.USERID, userInfo.userid);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.UALTEMAIL, userInfo.alt_email);

                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ORGEMAIL, userInfo.org_email);

                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.UMOBILENO, userInfo.mobile_no);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.PASSWORD, user_password);

                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.DEVICE_TOKEN, regid);
                            ...
                            if (menu_tag != null) {
                                ...
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.MENU_TAGS, menu_tag.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.MENU_TITLES, menu_title.toString());
                            }

                            // Permissions
                            if (permission_config != null) {
                                permission = new DataStructureFramwork.Permission(permission_config);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ASSIGNMENT_MARK_PERMISSION, permission.assignment_permission.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.TEST_MARK_PERMISSION, permission.test_permission.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ACTIVITY_MARK_PERMISSION, permission.activity_permission.toString());
                            }

                            // Parent Request
                            if (request_config != null) {
                                requests = new DataStructureFramwork.Request(request_config);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.LEAVE_REQUEST, requests.leave_request.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.REQUEST_FOR_BOOK, requests.request_for_book.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.REQUEST_FOR_ID_CARD, requests.request_for_id.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.REQUEST_FOR_UNIFORM, requests.request_for_uniform.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.SPECIAL_REQUEST, requests.special_request.toString());
                            }

                            // Permission Add
                            if (permission_add != null) {
                                permissionadd = new DataStructureFramwork.PermissionAdd(permission_add);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ASSIGNMENT_ADD_PERMISSION, permissionadd.assignment_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.TEST_ADD_PERMISSION, permissionadd.test_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ACTIVITY_ADD_PERMISSION, permissionadd.activity_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ANNOUNCEMENT_ADD_PERMISSION, permissionadd.announcement_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.COURSEWORK_ADD_PERMISSION, permissionadd.classwork_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.LESSONS_ADD_PERMISSION, permissionadd.lessons_add.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.ATTENDANCE_TYPE_PERMISSION, permissionadd.attendance_type.toString());
                            ...
                            if (userInfo.usertypeid.equalsIgnoreCase(Constants.USERTYPE_PARENT)) {
                                ...
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.CHILD_ID, selectedStudent.user_id);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.CHILD_NAME, selectedStudent.fullname);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.STUDENT_CLASS_SECTION, selectedStudent.class_section);
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.SELECTED_CHILD_OBJECT, object_chield_info.toString());
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.SECTION_ID, selectedStudent.section_id);

                            } else if (userInfo.usertypeid.equalsIgnoreCase(Constants.USERTYPE_STUDENT)) {
                                SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.CHILD_ID, userInfo.userid);
            ...
            protected void onPostExecute(Boolean result) {
                super.onPostExecute(result);
                if (result) {
                    if (!SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.USERTYPEID).equalsIgnoreCase(Constants.USERTYPE_PARENT)) {

                        SchoolAppUtils.SetSharedParameter(AimsRegistrationActivity.this, Constants.USERINFO, userInfo.toString());

                        if (SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.USERTYPEID).equalsIgnoreCase(Constants.USERTYPE_STUDENT)) {
                            SchoolAppUtils.SetSharedBoolParameter(AimsRegistrationActivity.this, Constants.UISSIGNIN, true);
                            Intent ints = new Intent(AimsRegistrationActivity.this, MainActivity.class);
                            ...
                            finish();
                        } else if (SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.USERTYPEID).equalsIgnoreCase(Constants.USERTYPE_TEACHER)) {
                            SchoolAppUtils.SetSharedBoolParameter(AimsRegistrationActivity.this, Constants.ISSIGNIN, true);
                        ...
                        SchoolAppUtils.SetSharedBoolParameter(AimsRegistrationActivity.this, Constants.ISSIGNIN, true);
                        SchoolAppUtils.SetSharedBoolParameter(AimsRegistrationActivity.this, Constants.ISPARENTSIGNIN, true);

                        Intent intent = new Intent(AimsRegistrationActivity.this, ParentMainActivity.class);
    ...
    private class GetOfflineDataAsyntask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("user_type_id", SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.USERTYPEID)));
            nameValuePairs.add(new BasicNameValuePair("organization_id", SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.UORGANIZATIONID)));
            nameValuePairs.add(new BasicNameValuePair("user_id", SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.USERID)));
            // Log parameters:
            String parameters = "";
            for (NameValuePair nvp : nameValuePairs) {
                parameters += nvp.getName() + "=" + nvp.getValue() + ",";
    ...
    private class GetOfflineDataStudentAsyntask extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (students != null) {
                ...
                mDatabase.close();
                Intent intent = new Intent(AimsRegistrationActivity.this, TeacherMainActivity.class);
                intent.putExtra("menu_val", menu_val);
                intent.putExtra("prompt", "1");
                startActivity(intent);
    ...
    //new student alert
    private class GetCheckStudentStatus extends AsyncTask<List<NameValuePair>, Void, Boolean> {
        ProgressDialog dialog;
        String error = "";
        String data_obj;
        ...
        protected Boolean doInBackground(List<NameValuePair>... params) {
            ...
            List<NameValuePair> namevaluepair = params[0];
            JsonParser jParser = new JsonParser();
            JSONObject json = jParser.getJSONFromUrlfrist(namevaluepair, SchoolAppUtils.GetSharedParameter(AimsRegistrationActivity.this, Constants.COMMON_URL) + Urls.api_aims_check_student_status);
            try {
                if (json != null) {
                    if (json.getString("result").equalsIgnoreCase("1")) {
                        try {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                ...
                if (error.length() > 0) {
                    SchoolAppUtils.showDialog(AimsRegistrationActivity.this, AimsRegistrationActivity.this.getTitle().toString(), error);
                    register.setEnabled(false);
                    register.setBackgroundResource(R.drawable.blue_fade_style);

                } else {
                    SchoolAppUtils.showDialog(AimsRegistrationActivity.this, AimsRegistrationActivity.this.getTitle().toString(), getResources().getString(R.string.error));
                }
